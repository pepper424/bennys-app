...
(function (root, factory) {
  ...
  function benefitHTML(b) {
    ...
    return '<div class="' + cls + '">' +
      ...
      '<div class="bc-foot">' +
      '<div class="bc-toggle">' + toggleHTML(b) + '</div>' +
  ...
  function dashView() {
    ...
    if (S.tab === "alerts") {
      ...
      urg.forEach(function (b) { h += benefitHTML(b); });
  ...
  function installView() {
    ...
    h += '<div class="sub" style="text-align:center;font-size:.92rem;' +
      ...
      'First, add Bennys to your home screen</div>' +
    ...
    if (S.platform.ios) {
      h += '<div class="section">' +
        ...
        '<div class="hint">Then open Bennys from your home screen and ' +
        'create your account there.</div></div>';
    } else if (S.deferredInstall) {
      h += '<button data-a="install-now">&#8681; Add Bennys to my home ' +
        'screen</button>' +
      ...
      h += '<div class="section">' +
        ...
        'Bennys</b> or <b>Add to Home screen</b>. On a computer, look ' +
